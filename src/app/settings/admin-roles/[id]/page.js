import RoleView from "@/components/settings-admin-roles/RoleView";
...
export const metadata = {
  title: "View Role · Shop My Band Admin",
};

export const dynamic = "force-dynamic";

export default async function ViewAdminRolePage({ params, searchParams }) {
  ...
  try {
    ...
    return <RoleView role={role} saved={typeof saved === "string" ? saved : undefined} />;
  } catch (error) {
