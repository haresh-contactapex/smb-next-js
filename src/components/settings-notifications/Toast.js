...
export default function Toast({ message, visible, variant = "success", durationMs = 2200, onDismiss }) {
  ...
  }, [visible, message, variant, durationMs]);
  ...
  if (variant === "error") {
    return (
      ...
      >
        <div className="relative overflow-hidden bg-red-600 text-white rounded-xl shadow-popover pl-4 pr-9 py-3.5">
