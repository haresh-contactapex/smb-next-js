...
export default function CustomersStats({ stats }) {
  const cards = [
    { icon: "users", iconColor: "accent", value: stats.total, label: "Total Customers" },
    { icon: "check-circle", iconColor: "success", value: stats.registered, label: "Registered" },
    { icon: "user", iconColor: "info", value: stats.guest, label: "Guest Checkouts" },
    { icon: "mail", iconColor: "warning", value: stats.marketingOptIn, label: "Marketing Opt-in" },
  ];
