...
export default function CouponsStats({ stats }) {
  const cards = [
    { icon: "tag", iconColor: "accent", value: stats.total, label: "Total Coupons" },
    { icon: "check-circle", iconColor: "success", value: stats.active, label: "Active" },
    { icon: "clock", iconColor: "info", value: stats.scheduled, label: "Scheduled" },
    { icon: "x-circle", iconColor: "error", value: stats.expired, label: "Expired" },
  ];
