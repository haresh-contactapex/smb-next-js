...
export default function ToggleField({ icon, label, description, checked, onChange, disabled = false }) {
  return (
    <label
      className={`flex items-center justify-between gap-4 py-1.5${disabled ? " opacity-50 cursor-not-allowed" : " cursor-pointer"}`}
    >
